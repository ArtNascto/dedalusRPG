...
func (uc *UserCreate) SetDaysOff(s string) *UserCreate {
	uc.mutation.SetDaysOff(s)
	return uc
}

// SetNillableDaysOff sets the "days_off" field if the given value is not nil.
func (uc *UserCreate) SetNillableDaysOff(s *string) *UserCreate {
	if s != nil {
		uc.SetDaysOff(*s)
	}
	return uc
...
func (uc *UserCreate) defaults() {
	...
	if _, ok := uc.mutation.DaysOff(); !ok {
		v := user.DefaultDaysOff
		uc.mutation.SetDaysOff(v)
	}
}
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.DaysOff(); !ok {
		return &ValidationError{Name: "days_off", err: errors.New("ent: missing required field \"days_off\"")}
	}
	return nil
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.DaysOff(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
